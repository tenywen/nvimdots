...
local plug_map = {
	...
	["i|<C-|>"] = map_cmd("<Esc><Cmd>ToggleTerm direction=vertical<CR>")
		...
		:with_silent()
		:with_desc("terminal: Toggle vertical"),
	["t|<C-|>"] = map_cmd("<Esc><Cmd>ToggleTerm direction=vertical<CR>")
		:with_noremap()
		:with_silent()
		:with_desc("terminal: Toggle vertical"),
    ["n|<C-t>"] = map_cmd("<Esc><Cmd>ToggleTerm direction=float<CR>")
		:with_noremap()
		:with_silent()
		:with_desc("terminal: Toggle Term"),
	["i|<C-t>"] = map_cmd("<Esc><Cmd>ToggleTerm direction=float<CR>")
		:with_noremap()
		:with_silent()
		:with_desc("terminal: Toggle Term"),
    ["t|<C-t>"] = map_cmd("<Esc><Cmd>ToggleTerm direction=float<CR>")
		:with_noremap()
		:with_silent()
		:with_desc("terminal: Toggle Term"),
	["t|<ESC>"] = map_cmd("<Esc><Cmd>ToggleTerm<CR>"):with_noremap():with_silent():with_desc("terminal: Toggle float"),
